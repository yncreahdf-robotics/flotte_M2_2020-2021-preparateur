...
"""autogenerated by genpy from test_serial_arduino/testRequest.msg. Do not edit."""
import codecs
import sys
...
class testRequest(genpy.Message):
  ...
  _type = "test_serial_arduino/testRequest"
...
def _get_struct_2q():
    ...
    return _struct_2q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test_serial_arduino/testResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class testResponse(genpy.Message):
  ...
  _type = "test_serial_arduino/testResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
def _get_struct_q():
    ...
    return _struct_q
class test(object):
  _type          = 'test_serial_arduino/test'
